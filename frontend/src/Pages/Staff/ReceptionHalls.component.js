...
export default class StaffCatering extends Component {
    ...
    UserList() {
        ...
        if(email ==null || email===""){
            ...
            return this.state.users.map(function(currentSignUpCustomer, i){
                if(currentSignUpCustomer.signup_type === "2" && currentSignUpCustomer.signup_category === "Halls" && currentSignUpCustomer.signup_email.toLowerCase() === email ){
                return <SignUpCustomer signupcustomer={currentSignUpCustomer} key={i} />;
                }
                return null;
            })
        ...
        return (
            <div>
                ...
                <div className="right">
                    ...
                    <div>
                    <h3 lassName="sp_head">List of Registered Reception Halls</h3>
                    <Form>
                        <FormGroup>
